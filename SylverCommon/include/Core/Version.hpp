...
namespace Sylver {
    ...
    struct Version {
            ...
            Version(u32 major = 0, u32 minor = 1, u32 patch = 0, const std::string& prerelease = "", const std::string& build = "") :
             ...
             */
            inline static std::optional<Version> FromString(const std::string& semVer) {
                if (!Validate(semVer)) {
